...
const CreateWithIngredientsAbl = require("../abl/recipe/createWithIngredients-abl");
...
router.post("/createWithIngredients", async (req, res) => {
    await CreateWithIngredientsAbl(req, res)
});
